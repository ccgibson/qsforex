...
class HistoricCSVPriceHandler(PriceHandler):
    ...
    def _open_convert_csv_files_for_day(self, date_str):
        ...
        return pd.concat(self.pair_frames.values()).sort_values(by='Time').iterrows()
# Note: Used sort_values as sort() was deprecated.  Not entirely sure if sort_values vs. sort_index
